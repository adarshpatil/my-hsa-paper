...
\par Several recent proposals advocate the use of on-chip DRAM capacity as a hardware managed last level cache for improving performance of multicore CMPs \cite{alloy,bimodal,loh-hill,atcache,footprint}. This also reduces energy consumed per access for the overall system.
...
\begin{itemize}
	...
	\item We compare \cachename\ against state-of-the-art DRAMCache proposals, namely Staged Memory Scheduling \cite{sms} and Mostly Clean DRAMCache \cite{mostly-clean} and demonstrate that \cachename\ outperforms these schemes by
\end{itemize}
