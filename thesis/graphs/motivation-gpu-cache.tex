...
\begin{document}
	...
	\begin{axis}[
	ylabel style={}, ylabel = Reduction in Num of Requests to DRAM,
	ybar=1pt,
	ymode=log,
	ymin=1e0,
	bar width=12pt,
	...
	\addlegendentry{\footnotesize{GPU Rd Req 64M 2way D$\$$}}
	\addlegendentry{\footnotesize{GPU Rd Req 128M 2way D$\$$}}
	...
	\label{cpureq}
	\addlegendimage{/pgfplots/refstyle=cpureq}\addlegendentry{\footnotesize{CPU Rd Req 64M 1way D\$}}
