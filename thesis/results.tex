...
\section{Effect of Interference in IHS architecture}
In this section, we quantify the effect of CPU and GPU co-running in a basic IHS architecture while sharing the memory subsystem. Figure ?? shows the performance of (a)CPU and (b)GPU 
