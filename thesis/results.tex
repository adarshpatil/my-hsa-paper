...
In this chapter, we evaluate the results of the proposed \cachename\ mechanisms discussed in Section \ref{section-hashcache}. We also compare \cachename\ approach against some of the related works. Further, we show that \cachename\ solution is robust and scales well by performing sensitivity study for the various components.
