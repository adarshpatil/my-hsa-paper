...
\begin{tikzpicture}[scale=0.5]
    ...
    \begin{axis}[
        ...
        \addlegendentry{\footnotesize{CPU alone w/o D$\$$}}
        \addlegendentry{\footnotesize{co-run w/o D$\$$}}
        \addlegendentry{\footnotesize{co-run w/ D$\$$}}
        \addlegendentry{\footnotesize{CPU alone w/ D$\$$}}
