...
\begin{tikzpicture}[scale=0.5]
    \pgfplotstableread[col sep = comma]{data/results-weighted-speedup.csv}\datatable

    \begin{axis}[
        ylabel style={}, ylabel = Weighted Speedup for IHS,
        ybar=1pt,
        bar width=4pt,
        xlabel=Workloads,
        ...
        \addplot [bar3] table[x=X,y=bloom] {\datatable};        
        \addplot [bar4] table[x=X,y=bloom+prio] {\datatable};
        \addplot [bar5] table[x=X,y=chain+prio] {\datatable};

        \addlegendentry{\footnotesize{naive DRAM$\$$}}
