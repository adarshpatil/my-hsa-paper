...
\newcommand{\bloom}[0]{
    \begin{tikzpicture}[auto, >=latex']
        ...
        \node [textblock, thick, left = 0.01cm of dramcache] (queue){\begin{varwidth}{4cm} \centering{\footnotesize{| | | |}} \end{varwidth}};
        ...
        \draw [<-, very thick] (queue.south) to ++(0,-0.8) to [out=180,in=0] ++(-1.35,0) to (bye.north);
        ...
        \node [plain, below=0.15cm of maydir, minimum height=1em, minimum width=1em, xshift=1.5cm, yshift=0.2cm] (wrhit) {\begin{varwidth}{4cm}\scriptsize{Write Hit}\end{varwidth}};
        ...
        \node [plain, right=0.01pt of dram, minimum height=1em, minimum width=1em] (cpubypass) {\begin{varwidth}{4cm}\scriptsize{CPU\\Bypass}\end{varwidth}};
...
%        \draw [->,very thick] (chaintable.south) to [out=0,in=180] ++(9.65,0) to (mem.south);
        ...
        \draw [->,very thick] (chaintable.east) to [out=0,in=180] ++(5.5,0) to (chaintad.south);
        \draw [->,very thick] (chaintable.east) to [out=0,in=180] ++(0.3,-0.4) to [out=0,in=180] ++(9.3,0) to (mem.south);
        ...
        \node [plain, above=0.3em of lbl10, minimum height=1em, minimum width=1em, xshift=0.5em] (lbl11) {\scriptsize{\emph{Return Data}}};
