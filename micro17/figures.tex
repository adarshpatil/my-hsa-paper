...
%        \draw [->,very thick] (chaintable.south) to [out=0,in=180] ++(9.65,0) to (mem.south);
        ...
        \draw [->,very thick] (chaintable.east) to [out=0,in=180] ++(5.65,0) to (chaintad.south);
        \draw [->,very thick] (chaintable.east) to [out=0,in=180] ++(0.3,-0.4) to [out=0,in=180] ++(9.6,0) to (mem.south);
