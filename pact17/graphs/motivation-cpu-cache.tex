...
%        \addlegendentry{\footnotesize{Hit Rate CPU\+GPU}}
   \addlegendimage{/pgfplots/refstyle=onlycpuhitrate}\addlegendentry{\footnotesize{HitRate onlyCPU D$\$$}}
   \addlegendimage{/pgfplots/refstyle=cpu+gpuhitrate}\addlegendentry{\footnotesize{HitRate CPU+GPU D$\$$}}
