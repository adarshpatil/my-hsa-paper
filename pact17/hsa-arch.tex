...
\tikzstyle{plain} = []
\tikzstyle{decisionblock} = [draw, diamond, fill=blue!20]
...
\newcommand{\chainaccess}[0]{
    \begin{tikzpicture}[auto, >=latex']
        ...
        \node [decisionblock, thick, right = 0.5cm of tagmatch, minimum height=5em] (clean) {\begin{varwidth}{4cm} \centering{\footnotesize{Clean?}} \end{varwidth}};
        \node [decisionblock, thick, right = 0.5cm of clean, minimum height=5em] (pamreturn) {\begin{varwidth}{4cm} \centering{\footnotesize{PAM \\return?}} \end{varwidth}};
        \node [textblock, thick, right = 5.5cm of chaintable] (chaintad) {\begin{varwidth}{4cm} \centering{\footnotesize{Chain\\TAD}} \end{varwidth}};
        \node [textblock, thick, right = 3cm of pamreturn, minimum height=7em] (mem) {\begin{varwidth}{4cm} \centering{\footnotesize{Memory}} \end{varwidth}};

        \draw [->,very thick] (act) -- (burst);
        \draw [->,very thick] (chaintable) -- (clean);
        \draw [->,very thick] (burst) -- (tagmatch);
        \draw [->,very thick] (tagmatch) -- (clean);
        %\draw [->,very thick] (clean.south)  to [out=-90, in=0] --(0,-2) to (chaintad);
