...
\newcommand{\chainaccess}[0]{
    \begin{tikzpicture}[auto, >=latex']
        ...
        % Row Buffer
        \node [rectblock, thick, below = 2.2cm of act, minimum width=6em] (data) {\begin{varwidth}{4cm} \centering{\scriptsize{Data}} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of data, minimum width=3em] (tag) {\begin{varwidth}{4cm} \centering{\scriptsize{Tag}} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of tag] (chain) {\begin{varwidth}{4cm} \centering{\scriptsize{C}} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of chain] (reversechain) {\begin{varwidth}{4cm} \centering{\scriptsize{R}} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of reversechain] (chaindirty) {\begin{varwidth}{4cm} \centering{\scriptsize{D}} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of chaindirty, minimum width=20em] (row) {\begin{varwidth}{4cm} \centering{...} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of row, minimum width=1.5em] (cg) {\begin{varwidth}{4cm} \centering{} \end{varwidth}};
        \node [rectblock, thick, right = 0cm of cg, minimum width=1.5em] (dc) {\begin{varwidth}{4cm} \centering{} \end{varwidth}};
        \draw [decorate,decoration={brace,amplitude=10pt},yshift=8.2em, xshift=-2.8em] (0,-5.5) -- (3.1,-5.5) node [black,midway,yshift=1em] {\scriptsize $128B + 8B$};
        \draw [decorate,decoration={brace,amplitude=10pt},yshift=8.2em, xshift=-2.8em] (11.5,-5.5) -- (12.5,-5.5) node [black,midway,yshift=1em] {\scriptsize $8B$ unused};
        ...
        \node [plain, above=0.1cm of reversechain, minimum height=1em, minimum width=1em, xshift=1em] (lbl32) {\begin{varwidth}{4cm} \centering{\scriptsize{2bit Reverse Chain}} \end{varwidth}};
        \node [plain, below=0.1cm of chaindirty, minimum height=1em, minimum width=1em, xshift=1em] (lbl33) {\begin{varwidth}{4cm} \centering{\scriptsize{1bit Chain Dirty}} \end{varwidth}};
        ...
        \draw [<-] (reversechain.north) to [out=90,in=-90] ++(0,0.2);
