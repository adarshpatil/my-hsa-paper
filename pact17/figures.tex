...
\newcommand{\bloom}[0]{
    \begin{tikzpicture}[auto, >=latex']
        ...
        \draw [->, very thick] (dramcache.east) to [out=0,in=180] ++(2.4,0) to (dram.north);
        \draw [->, very thick] (dramcache.south) to [out=90,in=-90] ++(-0.2,-0.2) to [out=180,in=0] ++(-2.6,0) to (bye.north);
        ...
        \draw [->, very thick] (0,2.5) to [out=180,in=0] ++(1.3,0) to (dramcache.west);
        \draw [->, very thick] (0,1.5) to [out=180,in=0] ++(1.3,0) to (dramcache.west);
        \draw [-, very thick, xshift=3.2cm] (0,1.3) to (0,0.1);
        \draw [-, very thick, xshift=3.2cm, right=90, looseness=3] (-0.04,0.1) to (0,-0.1);
        \draw [-, very thick, xshift=3.2cm] (0,-0.1) to (0,-1.4);
        ...
        \node [plain, left=0.2cm of dramcache, minimum height=1em, minimum width=1em, yshift=-1em] (WrReq) {\begin{varwidth}{4cm}\scriptsize{CPU Wr Req.}\end{varwidth}};
        \node [plain, left=0.2cm of dramcache, minimum height=1em, minimum width=1em, yshift=1.8em] (GpuReq) {\begin{varwidth}{4cm}\scriptsize{GPU R/W Req.}\end{varwidth}};
...
%        \draw [->,very thick] (chaintable.south) to [out=0,in=180] ++(9.65,0) to (mem.south);
        ...
        \node [plain, right=0.01em of chainmatch, minimum height=1em, minimum width=1em, yshift=-0.5em, xshift=-0.41em] (lbl5) {\scriptsize{\emph{Miss}}};
        ...
        \node [plain, right=2.5em of lbl6, minimum height=1em, minimum width=1em, yshift=1.5em] (lbl7) {\scriptsize{\emph{No}}};
        \node [plain, above=1.8em of clean, minimum height=1em, minimum width=1em, xshift=-0.1em] (lbl9) {\scriptsize{\emph{Yes}}};
        \node [plain, above=1.8em of chaintad, minimum height=1em, minimum width=1em, yshift=0.5em, xshift=-1.5em] (lbl10) {\scriptsize{\emph{Yes}}};
        \node [plain, above=0.3em of lbl10, minimum height=1em, minimum width=1em] (lbl11) {\scriptsize{\emph{Return Data}}};
        \node [plain, left=9.7em of lbl11, minimum height=1em, minimum width=1em] (lbl12) {\scriptsize{\emph{Return Data}}};
