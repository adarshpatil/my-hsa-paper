...
\newcommand{\bloom}[0]{
    \begin{tikzpicture}[auto, >=latex']
        ...
        \node [textblock, thick, minimum width=4em, right = 5cm of bye, minimum height=7em, yshift=-0.5cm] (dram){\begin{varwidth}{4cm} \centering{\footnotesize{Off Chip\\DRAM}} \end{varwidth}};
