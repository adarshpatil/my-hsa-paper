...
\begin{document}
    ...
    \begin{tikzpicture}[auto, >=latex']
       ...
       % \end{scope}
        ...
        % Off package Region
        \node [blocksmall, draw=blue, minimum height=0.5em, minimum width=0.5em] at (5.85,5.15)(mm1){};
       ...
       \end{scope}
        ...
        % Labels
        \node [blocksmall, draw=white, minimum height=1em, minimum width=1.2em] at (0.3,4.0)
